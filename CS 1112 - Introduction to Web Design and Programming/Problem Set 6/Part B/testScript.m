...
i1.scale(2) %Interval with endpoints 3 and 15
L=i1.left
R=i1.right
i1.shift(5) % Interval with endpoints 8 and 20
L=i1.left
R=i1.right
disp(i1.isIn (Interval(1,20) )) %should be true (1)
disp(i1.isIn( Interval(1,5) )) %should be false (0)
i1.add( Interval(3,3) ) %Interval from 11 to 23
...
disp(e1.earliestTime( Interval(5,15) )) %should be 5
disp(e1.getId()) %should be 4
