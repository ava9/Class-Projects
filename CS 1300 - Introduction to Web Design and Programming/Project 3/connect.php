<?php
	...
	if (isset($_POST['submit'])){
	    ...
	    if (strlen($message) > 250){
	     	$messageerror = "<div class='error'>*Message is not less than 250 characters</div>";
	    }
	...
	<body class="body">
		...
		<form action="connect.php" method="POST">
	  		...
	  		<div>
	    		...
	    		<input id="gender" type="radio" name="gender" <?php if (isset($gender) && $gender=="male") echo "checked";?> value="male">Male
				<input id="gender" type="radio" name="gender" <?php if (isset($gender) && $gender=="female") echo "checked";?> value="female">Female
	    		<?php echo $gendererror ?>
	  		</div>
	  		<br>
			<div>
				<label for="mail">E-mail:</label>
				<input id="mail" type="text" name="email" value="<?php echo $email ?>"/>
				<?php echo $emailerror ?>
			</div>
			<br>
			<div>
			...
			<div>
				...
				<input id="org" type="text" name="org" value="<?php echo $org ?>"/>
				<?php echo $orgerror ?>
			</div>
			<br>
			<div>
				<label for="intent">Intent:</label>
				<input id="intent" type="radio" name="intent" value="Recruiting"
					<?php if (isset($intent) && $intent=="Recruiting") echo "checked";?>>Recruiting
				<input id="intent" type="radio" name="intent" value="Project Question" 
						<?php if (isset($intent) && $intent=="Project Question") echo "checked";?>>Project Question
				<input id="intent" type="radio" name="intent" value="General Inquiry" 
			...
			<br>
	  		<div>
	    		...
	    		<textarea id="message" name="message" rows="5" cols="40" placeholder="Please enter your message here." ><?php echo $message ?></textarea>
